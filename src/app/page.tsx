...
export default function Home() {
  return (
    <Fragment>
        <div id="Home" className="pt-4 pb-6 2xl:px-12 lg:px-8 max-w-full lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mx-auto flex flex-col lg:flex-row mt-8 items-center justify-center lg:justify-between">
          ...
          <div className="pt-5 lg:pt-0">
            ...
            <div className="flex justify-end px-4">
              ...
              >
                ...
                expertise in building dynamic, scalable, and high-performance
                web applications. I specialize in modern web technologies like
                Nest.js, Next.js, Node.js, and PostgreSQL, crafting seamless
      ...
      <VerticalTech />
        ...
        <div  id="Education" className="mt-6 pt-6 pb-6 max-w-1400px lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mx-auto px-4 2xl:px-12 lg:px-8">
        ...
        <div id="Experience" className="pt-6 pb-6 max-w-full lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mx-auto px-4 2xl:px-12 lg:px-8">
          <div className="items-center text-center pt-4">
            <p className="text-[24px] md:text-[36px] lg:text-[40px] font-[600] text-[#8dced0]">
              Experience
            </p>
            ...
            <div className="border-l-2 border-l-inherit h-auto min-h-[12rem] lg:min-h-[11rem] mx-2">
              ...
              <div className="max-w-full md:w-[600px] lg:w-[700px] text-justify">
                ...
                <p className="font-[500] text-[16px] ml-4 py-1">
                  ...
                  contributed to frontend development & integration across 10+
                  key modules including Payroll, Forms, and Organization
                  Settings.
                </p>
              </div>
              ...
              <div className="max-w-full md:w-[600px] lg:w-[700px] text-justify mt-5">
                ...
                <p className="font-[500] text-[16px] ml-4 py-1">
                  {" "}
                  - As a Full Stack Developer, I contribute to client projects
                  by building responsive frontends with Next.js
                  (TypeScript,Tailwind CSS), HeroUI, and shadcn/ui, while
                  developing backend services using Express.js and Prisma ORM. I
                  design RESTful APIs, ensure seamless frontend-backend
                  integration, and collaborate with teams to deliver scalable
        ...
        <div id="Achievements" className="mt-6 pt-6 pb-6 max-w-1400px lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mx-auto px-4 2xl:px-12 lg:px-8">
          <div className="items-center text-center pt-4">
            <p className="text-[24px] md:text-[36px] lg:text-[40px] font-[600] text-[#8dced0]">
              Achievements
            </p>
        ...
        <div  id="Projects" className="mt-6 pb-12 max-w-1400px lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mx-auto px-4 2xl:px-12 lg:px-8">
          <div className="items-center text-center pt-4">
            <p className="text-[24px] md:text-[36px] lg:text-[40px] font-[600] text-[#8dced0]">
              Projects
            </p>
