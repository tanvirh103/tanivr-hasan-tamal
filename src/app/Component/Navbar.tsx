'use client'
import { Facebook, Github, LinkendIn, Mail, MobileMenuIcon } from "@/SVG/WelcomeSvg";
...
export default function Navbar() {
  ...
  return (
    <div>    <div className="sticky top-0 w-full z-50 max-w-1400px lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mx-auto px-4 2xl:px-12 lg:px-8 pt-8 bg-[#000000]">
    ...
    {isShowMenu&&(
        <MobileMenu setShow={setShowMenu}/>
      )}
    </div>
